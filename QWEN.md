...
- 📧 **Email Verification** — User email verification via Unisender Go Web API
...
│   │   ├── email/
│   │   │   └── sendEmail.js      # Email sending via Unisender Go Web API
...
| `UNISENDER_GO_API_KEY`      | Email API key         | Unisender Go API key                |
| `UNISENDER_GO_SENDER_EMAIL` | Verified sender email | `no-reply@example.com`              |
| `UNISENDER_GO_SENDER_NAME`  | Sender display name   | `IT-Eco-For-SP`                     |
