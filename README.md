...
> 🤖 **Для работы с ИИ-ассистентом (ChatGPT, Qwen Code, etc.):**
> Передайте файл [CONTEXT.md](./CONTEXT.md) для получения полной информации о проекте.
> Этот файл содержит всю необходимую информацию для понимания архитектуры, статуса разработки и ключевых файлов.
